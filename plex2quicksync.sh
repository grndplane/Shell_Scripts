...
# Add the --encopts option with the Intel Quick Sync Video settings for H.265
$handbrake -i "$inFile" -o "$tmpFile" --preset="Fast 1080p30" --encoder="x265_10bit" --encopts="rate_control=CBR" -O
